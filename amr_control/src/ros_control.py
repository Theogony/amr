...
#from amr_control.msg import Pose
import math
import time
...
if __name__ == '__main__':
    try:
        ...
        rospy.init_node('amr_control', anonymous=True)
        port_1 = rospy.get_param('~motor_port_1')
        port_2 = rospy.get_param('~motor_port_2')
        port_3 = rospy.get_param('~motor_port_3')
        port_4 = rospy.get_param('~motor_port_4')
        motor_1 = MotorDriver(port_1)
        motor_2 = MotorDriver(port_2)
        motor_3 = MotorDriver(port_3)
        motor_4 = MotorDriver(port_4)
        rospy.sleep(5)
        motor_1.set_speed(1000)
        motor_2.set_speed(1000)
        motor_3.set_speed(1000)
        motor_4.set_speed(1000)
        motor_1.start()
        motor_2.start()
        motor_3.start()
        motor_4.start()
...
motor_3.stop()
motor_4.stop()
my_service = rospy.Service('/amr_motor', SetBool, setbool_response)
rospy.spin() """